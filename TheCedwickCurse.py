...
# print(textwrap.fill(text, width=80))
# text ="On Hallow's Eve, Frank's company broke ground on a new factory, a top of an ancient Burial ground."
# print(textwrap.fill(text, width=80))
# print()
# s1 = "'You have trespassed on our land and tarnished out sacred place!', an old ghastly witch doctor shouted at Frank."
# for character in s1
# print(textwrap.fill(text, width=80))
# print()
